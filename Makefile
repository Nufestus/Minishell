...
#    Updated: 2025/06/03 14:00:39 by aammisse         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = minishell.c parsing/readinput.c utils/utils.c builtins/export.c \
		...
		execution/execution.c builtins/env_pwd.c builtins/cd_utils.c \
		...
		builtins/export_utils_2.c builtins/builtin_utils.c builtins/cd.c builtins/utils_built.c \
		...
		parsing/readinput_utils5.c execution/exec_utils.c execution/exec_utils_1.c env_help.c \
		execution/exec_utils_2.c execution/exec_utils_3.c execution/exec_utils_4.c execution/exec_utils_5.c \
		main.c builtins/export_stuff.c execution/exec_utils_6.c parsing/token_utils.c
