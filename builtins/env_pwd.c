...
/*   Updated: 2025/05/17 21:06:33 by rammisse         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	printpwd(int size, t_minishell *mini, char *path)
{
	if (size != 1)
	{
		if (path)
...
void	printenv(int size, t_minishell *mini)
{
	t_env	*env;
