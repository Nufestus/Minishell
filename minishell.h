...
/*   Updated: 2025/06/03 14:03:48 by aammisse         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			check_for_essentials(char *str, int *path,
					int *pwd, int *shlvl);
...
void			handle_env_node(char *str, t_env_setup *setup,
					t_minishell *mini);
...
void			add_env_node(t_minishell *mini, t_env_setup *setup,
					char *path_ref);
